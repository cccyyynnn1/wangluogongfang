        ...
        <el-col :span="21">
          <div class="right-panel">
            ...
            >
              ...
              <div class="toolbox">
                <div @click="() => settingsStore.changeDownloadVisible(true)">
                  <vab-icon icon="download-2-line" style="margin-left: 20px" />
                  <span>下载</span>
                </div>
                <div style="margin-left: 20px" @click="() => settingsStore.changeToolboxVisible(true)">
                  <vab-icon icon="apps-line" style="margin-left: 20px" />
                  <span>工具箱</span>
                </div>
              </div>
            </el-menu>
            <!-- <vab-error-log /> -->
            <vab-lock />
            <el-tooltip content="全屏" effect="light" placement="bottom">
              <vab-full-screen />
            </el-tooltip>
            <el-tooltip content="主题" effect="light" placement="right">
              <vab-theme />
            </el-tooltip>
            <!-- <vab-search /> -->
            <!-- <vab-notice /> -->
