...
<script lang="ts">
  ...
  const EcsAiChat = defineAsyncComponent(() => import('@/components/ai-chat.vue'))
  ...
  Components['EcsAiChat'] = EcsAiChat
  export default defineComponent({
    ...
    setup() {
      ...
      const { toggleDevice, foldSideBar, openSideBar, updateTheme, getSystemConfig } = settingsStore
