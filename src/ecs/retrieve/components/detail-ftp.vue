  ...
  <div class="datail-ftp">
    ...
    <el-descriptions border :column="2">
      ...
      <el-descriptions-item label="文件大小" :span="2">
        <div v-copy="infoVal?.fileSize" style="padding-right: 30px">{{ infoVal?.fileSize }}</div>
      </el-descriptions-item>
      <el-descriptions-item label="传输模式" :span="2">
        <div v-copy="infoVal?.transModel" style="padding-right: 30px">{{ infoVal?.transModel }}</div>
      </el-descriptions-item>
      <el-descriptions-item label="其他信息" :span="2">
        <div v-copy="infoVal?.otherInfo" style="padding-right: 30px">{{ infoVal?.otherInfo }}</div>
      </el-descriptions-item>
