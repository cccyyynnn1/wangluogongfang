...
<template>
  <div class="datail-db">
    ...
    <el-descriptions border :column="2">
      ...
      <el-descriptions-item label="执行的SQL" :span="2">
        <div v-copy="infoVal?.sql" style="padding-right: 30px">{{ infoVal?.sql }}</div>
      </el-descriptions-item>
      <el-descriptions-item label="执行结果" :span="2">
        <div v-copy="infoVal?.result" style="padding-right: 30px">{{ infoVal?.result }}</div>
      </el-descriptions-item>
      <el-descriptions-item label="SCHAME" :span="2">
        <div v-copy="infoVal?.schame" style="padding-right: 30px">{{ infoVal?.schame }}</div>
      </el-descriptions-item>
      <el-descriptions-item label="影响条数" :span="2">
        <div v-copy="infoVal?.matchedCount" style="padding-right: 30px">{{ infoVal?.matchedCount }}</div>
      </el-descriptions-item>
      <el-descriptions-item label="返回条数" :span="2">
        <div v-copy="infoVal?.returnCount" style="padding-right: 30px">{{ infoVal?.returnCount }}</div>
      </el-descriptions-item>
    </el-descriptions>
