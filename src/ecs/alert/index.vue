<script setup lang="ts">
  ...
  onMounted(async () => {
    ...
    if (route.query.threatType) {
      ...
      const _sql = `威胁类型 = "${route.query.threatType}"`
      sqlComponentsRef.value?.changeSql(_sql)
      timeDuration.value = '6hours'
    }
    getModelStatus()
    ...
    setTimeout(() => {
      queryData()
      getAllDisPlaysFiled()
      el.value = document.querySelector('.my-alarm-table .el-scrollbar__wrap')
