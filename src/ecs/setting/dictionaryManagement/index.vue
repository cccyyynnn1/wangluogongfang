    ...
    <el-row :gutter="20">
      <el-col :lg="4" :md="8" :sm="24" :xl="4" :xs="24">
        <vab-card shadow="hover">
          <el-button class="tree-button" :icon="Plus" type="primary" @click="handleEdit()">添加字典分类</el-button>
          ...
          >
            <template #default="{ node, data }">
              ...
              <a v-if="!data.children" style="float: right; margin-right: 10px" @click="remove(node, data)">删除</a>
            </template>
          </el-tree>
        </vab-card>
      </el-col>
      <el-col :lg="20" :md="16" :sm="24" :xl="20" :xs="24">
        <vab-card shadow="hover">
          ...
          <el-table v-loading="listLoading" border :data="list" @cell-contextmenu="useTableCopy">
...
<script>
  ...
  export default defineComponent({
    ...
    components: {
      Edit: defineAsyncComponent(() => import('./components/DictionaryManagementEdit')),
    },
    setup() {
